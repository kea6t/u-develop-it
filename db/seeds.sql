...
VALUES
  ('JS Juggernauts', 'The JS Juggernauts eat, breatheclear, and sleep JavaScript. They can build everything you could ever want in JS, including a new kitchen sink.'), 
